/** Agency retreat wizard step 1 — basic information.
 *  Name, type, nights, dates, capacity, language, description.
 *  All fields are required to enable the Next button. */
"use client";

import { useLocale } from "@/i18n/LocaleProvider";
import { computeEndDate, useAgencyRetreatWizard, type RetreatType } from "@/contexts/AgencyRetreatWizardContext";

const RETREAT_TYPES: RetreatType[] = [
  "wellness", "spiritual", "liderazgo_mujeres", "constelaciones_familiares",
...
export default function AgencyRetreatInfoStep() {
    ...
    <section className="rounded-xl border border-humana-line bg-white p-8 shadow-sm animate-fade-in-up">
      ...
      <div className="mt-8 flex flex-col gap-6">
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <Field label={tw.info.language} required>
            <select
