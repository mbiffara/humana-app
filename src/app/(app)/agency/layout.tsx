/** Agency workspace layout — guards for agency-org users and shows
 *  paywall overlay when no active subscription. */
"use client";
...
export default function AgencyLayout({ children }: { children: React.ReactNode }) {
  ...
  const isExempt = pathname.startsWith("/agency/settings") || pathname.startsWith("/onboarding");
