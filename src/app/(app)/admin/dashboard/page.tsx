...
export default function AdminDashboard() {
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-16 py-10">
      ...
      {/* View Sales CTA */}
      <div className="mb-10 flex justify-end animate-[fade-in-up_0.5s_ease-out_0.15s_both]">
        <button
          onClick={() => router.push("/admin/sales")}
          className="cursor-pointer inline-flex items-center gap-2.5 rounded-lg border border-humana-line bg-white px-5 py-3 text-[12px] font-semibold uppercase tracking-[0.14em] text-humana-ink transition-all duration-200 hover:border-humana-gold hover:shadow-md"
        >
          ...
          {t.admin.sales.viewSales}
          <svg className="h-3.5 w-3.5 text-humana-muted" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24">
