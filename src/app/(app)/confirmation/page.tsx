    ...
    <div className="flex flex-col items-center gap-10 px-16 py-20">
      ...
      <div className="animate-fade-in-up-delay-2 flex items-center gap-4">
        ...
        <Link
          href="/dashboard"
          onClick={reset}
          className="flex items-center justify-center gap-3 bg-humana-ink px-8 py-4 text-[13px] font-semibold uppercase tracking-[0.22em] text-white transition-all duration-150 hover:bg-black active:scale-[0.98]"
        >
          VER MIS RESERVAS
