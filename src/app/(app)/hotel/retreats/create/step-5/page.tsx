/** Retreat wizard step 5 — review all sections before publishing.
...
export default function RetreatReviewStep() {
  ...
  const pricedRooms = state.pricing
    ...
    .filter((row) => row.roomType && row.cents > 0);
  ...
  return (
    <div className="flex flex-col gap-5 animate-fade-in-up">
      ...
      <ReviewCard
        ...
        editHref="/hotel/retreats/create/step-1"
        editLabel={tw.review.edit}
      >
        <p className="text-[14px] font-medium text-humana-ink">{hotel?.name ?? "—"}</p>
        {hotel && (
      ...
      >
        <div className="flex flex-col divide-y divide-humana-line">
          ...
          <Row
            ...
            value={`${tr.nights(state.nights)} · ${dateRange}`}
          />
      ...
      <ReviewCard
        ...
        editHref="/hotel/retreats/create/step-4"
        editLabel={tw.review.edit}
      >
