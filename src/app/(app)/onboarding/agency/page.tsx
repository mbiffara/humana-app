/** Agency onboarding — Step 2 of 2: agency name + profile fields. */
"use client";
...
const STORAGE_KEY = "humana.onboarding.agency";
...
export default function AgencyOnboarding() {
  ...
  useEffect(() => {
    ...
    async function load() {
      ...
      try {
        ...
        // If API fails, still restore draft
  ...
  return (
    <div className="flex min-h-screen flex-col bg-humana-stone">
      <OnboardingHeader role="agency" currentStep={2} totalSteps={2} />
        ...
        {loading ? (
          ...
          <div className="w-full max-w-[480px] animate-[fade-in-up_0.5s_ease-out]">
            <div className="rounded-[6px] bg-white p-10 shadow-[0_2px_16px_rgba(0,0,0,0.08)]">
              ...
              <p className="mb-8 text-[14px] text-humana-muted">{t.onboarding.agency.subtitle}</p>

              <form onSubmit={handleSubmit} className="flex flex-col gap-5">
                {/* Agency Name */}
                <Field label={t.onboarding.agency.orgName}>
                  <input
                    required
                    value={orgName}
                    onChange={(e) => setOrgName(e.target.value)}
                    placeholder="Viajes Éter"
                ...
                <div className="grid grid-cols-2 gap-4">
                  <Field label={t.onboarding.agency.firstName}>
                    <input
                      required
                      value={firstName}
                  ...
                  <Field label={t.onboarding.agency.lastName}>
                    <input
                      required
                      value={lastName}
